...
# All effect-strength constants below are scaled 1.3x (+30%) from their
# original tuning at the user's request.
MAX_WARBLE_DEPTH = 0.026
MAX_BLOOM_DEPTH = 0.78
PER_LAYER_MIN_WARBLE = 0.0013
PER_LAYER_MAX_WARBLE = 0.0052
PER_LAYER_MIN_BLOOM = 0.026
PER_LAYER_MAX_BLOOM = 0.156
FINGER_HUE_MIN = 0.0
